...
func TestExtending(t *testing.T) {
	...
	l3.PushBackLinkedList(l1)
	checkLinkedList(t, l3, []int{1, 2, 3})
	l3.PushBackLinkedList(l2)
	checkLinkedList(t, l3, []int{1, 2, 3, 4, 5})

	l3 = NewLinkedList[int]()
	l3.PushFrontLinkedList(l2)
	checkLinkedList(t, l3, []int{4, 5})
	l3.PushFrontLinkedList(l1)
	checkLinkedList(t, l3, []int{1, 2, 3, 4, 5})
	...
	l3.PushBackLinkedList(l1)
	checkLinkedList(t, l3, []int{1, 2, 3})
	l3.PushBackLinkedList(l3)
	checkLinkedList(t, l3, []int{1, 2, 3, 1, 2, 3})

	l3 = NewLinkedList[int]()
	l3.PushFrontLinkedList(l1)
	checkLinkedList(t, l3, []int{1, 2, 3})
	l3.PushFrontLinkedList(l3)
	checkLinkedList(t, l3, []int{1, 2, 3, 1, 2, 3})

	l3 = NewLinkedList[int]()
	l1.PushBackLinkedList(l3)
	checkLinkedList(t, l1, []int{1, 2, 3})
	l1.PushFrontLinkedList(l3)
	checkLinkedList(t, l1, []int{1, 2, 3})
}
...
func TestZeroLinkedList(t *testing.T) {
	...
	l1.PushFront(1)
	checkLinkedList(t, l1, []int{1})

	l2 := new(LinkedList[int])
	l2.PushBack(1)
	checkLinkedList(t, l2, []int{1})

	l3 := new(LinkedList[int])
	l3.PushFrontLinkedList(l1)
	checkLinkedList(t, l3, []int{1})

	l4 := new(LinkedList[int])
	l4.PushBackLinkedList(l2)
	checkLinkedList(t, l4, []int{1})
}
